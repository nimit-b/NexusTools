...
const HtmlEntityConverter: React.FC<{ showToast: (message: string) => void }> = ({ showToast }) => {
    ...
    return (
         <div className="space-y-4">
            <TextArea
                ...
                rows={6}
                aria-label="Input for HTML entity conversion"
            />
            ...
            <div className="relative">
                <TextArea
                    ...
                    aria-label="HTML entity conversion output"
                />
                {output && (
                    <button
                        onClick={handleCopy}
